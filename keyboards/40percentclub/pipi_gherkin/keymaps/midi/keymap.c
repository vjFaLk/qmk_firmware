...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MENU] = LAYOUT_ortho_3x10(
    IONIAN,   LYDIAN,     LOCRIAN, SQ_TMPD, SQ_TMPU, _______, _______, SQ_SALL, SQ_TOG, SQ_ON,
    DORIAN,   MIXOLYDIAN, _______, SQ_RESD, SQ_RESU, _______, _______, SQ_SCLR, _______, SQ_OFF,
